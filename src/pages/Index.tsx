...
const Index = () => {
  ...
  const equipmentCategories = [
    ...
    {
      id: 'sorting-equipment',
      title: 'Сортировочное оборудование',
      description: 'Автоматизированные системы сортировки и обработки грузов',
      image: '/img/284673b2-2ded-417d-b7f5-97c3c704bbed.jpg',
      items: [
        { name: 'Конвейерная сортировка КС-2000', specs: 'Производительность: 2000 шт/час, Длина: 50м', status: 'В работе' },
        { name: 'Автоматический сортировщик АС-500', specs: 'Скорость: 500 посылок/час, Точность: 99.9%', status: 'В работе' },
        { name: 'Система барабанной сортировки БС-150', specs: 'Диаметр: 1.5м, Нагрузка: 150кг/м', status: 'Ремонт' },
        { name: 'Ленточный транспортер ЛТ-3000', specs: 'Длина: 300м, Ширина ленты: 1200мм', status: 'В работе' }
      ]
    },
    {
      id: 'lifting-attachments',
      title: 'Грузозахватные приспособления',
      description: 'Стропы, захваты, спредеры и вспомогательные устройства',
      image: '/img/6f46b9fb-d1a6-4870-9bfc-a39aa76c8bef.jpg',
      items: [
        { name: 'Контейнерный спредер СП-40', specs: 'Для контейнеров 20-40 футов, Вес: 8т', status: 'В работе' },
        { name: 'Строп четырехветвевой СЧ-10', specs: 'Грузоподъемность: 10т, Длина: 3м', status: 'В работе' },
        { name: 'Магнитный захват МЗ-5', specs: 'Подъемная сила: 5т, Диаметр: 1.2м', status: 'Проверка' },
        { name: 'Крюк поворотный КП-50', specs: 'Грузоподъемность: 50т, Материал: сталь 20ГЛ', status: 'В работе' }
      ]
    },
    {
      id: 'manufacturing',
